...
survey_df$Overpaid <- factor(survey_df$Overpaid, levels = c("Somewhat underpaid", "Neither underpaid nor overpaid", "Greatly underpaid","Somewhat overpaid",  "Greatly overpaid"))
...
overpaid_each_country$Overpaid <- factor(overpaid_each_country$Overpaid, levels = c("Somewhat underpaid", "Neither underpaid nor overpaid", "Greatly underpaid","Somewhat overpaid",  "Greatly overpaid"))
